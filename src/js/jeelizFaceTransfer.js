...
var JEEFACETRANSFERAPI = (function () {
  ...
  function va() {
    for (var b = a.yb, d = Array(b), e = 0; e < b; ++e) d[e] = 0;
    return d;
  }
  function ya(b, d, e) {
  ...
  function Ba(b, d, e, g) {
    return Math.pow(Math.min(Math.max((g - b) / (d - b), 0), 1), e);
  }
  function Da(b) {
    switch (b) {
      case "relu":
  ...
  function Ha(b) {
    ...
    var e = d.nf,
      ...
      l =
        "undefined" === typeof btoa
          ? Buffer.from(d.data, "base64").toString("latin1")
          : atob(d.data),
      k = l.length,
      r;
    d = new Uint8Array(k);
    for (r = 0; r < k; ++r) d[r] = l.charCodeAt(r);
    ...
    for (m = 0; m < g; ++m) {
      ...
      var z = 1,
        C = 0;
      for (n = t + b - 1; n >= t; --n) (C += z * Ga(d, n)), (z *= 2);
      n = C;
      t = d;
      z = f + 1 + b;
      C = k;
      var N = 0,
        J = C.length;
      for (f = z; f < z + J; ++f) (C[N] = Ga(t, f)), ++N;
      for (f = t = 0; f < e; ++f) t += k[f] * Math.pow(2, -f - 1);
      u =
        0 === t && 0 === n
          ? 0
          : u * (1 + t) * Math.pow(2, 1 + n - Math.pow(2, b - 1));
      l[m] = u;
    }
    return l;
  }
  var v = (function () {
      ...
      function d(h, w) {
        h = b(p.VERTEX_SHADER, h);
        w = b(p.FRAGMENT_SHADER, w);
      ...
      function e(h) {
        ...
        void 0 === h.ca && (h.ca = ["a0"]);
        void 0 === h.U && (h.U = [2]);
        if (void 0 === h.precision || "highp" === h.precision) h.precision = n;
        h.id = r++;
        void 0 !== h.Vc &&
          h.Vc.forEach(function (y, aa) {
            h.c = h.c.replace(y, h.pa[aa]);
          });
        h.Sa = 0;
        h.U.forEach(function (y) {
          h.Sa += 4 * y;
        });
        h.oa = d(h.$, "precision " + h.precision + " float;\n" + h.c);
        h.l = {};
        h.f.forEach(function (y) {
          h.l[y] = p.getUniformLocation(h.oa, y);
        });
        h.attributes = {};
        h.V = [];
        h.ca.forEach(function (y) {
          var aa = p.getAttribLocation(h.oa, y);
          h.attributes[y] = aa;
          h.V.push(aa);
        });
        if (h.h) {
          ...
          k = h;
          l = h.id;
          for (var w in h.h) p.uniform1i(h.l[w], h.h[w]);
        }
        h.Md = !0;
      }
      function g(h) {
        ...
        l !== h.id &&
          ...
          (k = h),
          p.useProgram(h.oa),
          h.V.forEach(function (w) {
            0 !== w && p.enableVertexAttribArray(w);
          }));
      }
      var l = -1,
        k = !1,
        ...
        F = {
          ...
          nb: function (h, w, y) {
            w || (w = h);
            J[w] = Object.create(O[h]);
            O[h].pa &&
              O[h].pa.forEach(function (aa, oa) {
                J[w].c = J[w].c.replace(new RegExp(aa, "g"), y[oa]);
              });
            e(J[w], w);
          },
          set: function (h) {
          ...
          S: function () {
            -1 !== l &&
              ((l = -1),
              k.V.forEach(function (h) {
                0 !== h && p.disableVertexAttribArray(h);
              }));
          },
          Pa: function () {
            var h = 0;
            k.V.forEach(function (w, y) {
              y = k.U[y];
              p.vertexAttribPointer(w, y, p.FLOAT, !1, k.Sa, h);
              h += 4 * y;
            });
          },
          ud: function () {
          ...
          Qa: function () {
            p.vertexAttribPointer(k.V[0], 2, p.FLOAT, !1, 8, 0);
          },
          Yd: function (h, w) {
            p.uniform1i(k.l[h], w);
          },
          ...
          I: function (h, w, y) {
            p.uniform2f(k.l[h], w, y);
          },
          Zd: function (h, w) {
            p.uniform2fv(k.l[h], w);
          },
          $d: function (h, w) {
            p.uniform3fv(k.l[h], w);
          },
          Ib: function (h, w, y, aa) {
            p.uniform3f(k.l[h], w, y, aa);
          },
          Jb: function (h, w) {
            p.uniform4fv(k.l[h], w);
          },
          ae: function (h, w) {
            p.uniformMatrix2fv(k.l[h], !1, w);
          },
          be: function (h, w) {
            p.uniformMatrix3fv(k.l[h], !1, w);
          },
          ce: function (h, w) {
            p.uniformMatrix4fv(k.l[h], !1, w);
          },
          C: function (h, w) {
            F.set(h);
            w.forEach(function (y) {
              switch (y.type) {
                case "4f":
                  p.uniform4fv(k.l[y.name], y.value);
                  break;
                case "3f":
                  p.uniform3fv(k.l[y.name], y.value);
                  break;
                case "2f":
                  p.uniform2fv(k.l[y.name], y.value);
                  break;
                case "1f":
                  p.uniform1f(k.l[y.name], y.value);
                  break;
                case "1i":
                  p.uniform1i(k.l[y.name], y.value);
                  break;
                case "mat2":
                  p.uniformMatrix2fv(k.l[y.name], !1, y.value);
                  break;
                case "mat3":
                  p.uniformMatrix3fv(k.l[y.name], !1, y.value);
                  break;
                case "mat4":
                  p.uniformMatrix4fv(k.l[y.name], !1, y.value);
              }
            });
          },
          Fd: function () {
    ...
    La = (function () {
      function b(f) {
        console.log("ERROR in ContextFeedForward : ", f);
        return !1;
      }
      function d() {
        if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) {
          ...
          return 12 === f[0] || 13 === f[0] ? !0 : !1;
        }
        return /(Mac)/i.test(navigator.platform) &&
          ((f = navigator.userAgent)
            ? ((f = f.match(/Mac OS X (\d+)_(\d+)/)),
              (f =
                3 > f.length ? !1 : [parseInt(f[1], 10), parseInt(f[2], 10)]))
            : (f = !1),
          f && 10 === f[0] && 15 === f[1])
          ? !0
          : !1;
      ...
      var e = !1,
        ...
        n = {
          ...
          pc: function () {
            ...
            p.readPixels(0, 0, e.width, e.height, p.RGBA, p.UNSIGNED_BYTE, m);
            return m;
          },
          Ad: function () {
          ...
          Bd: function () {
            ...
            g.height = e.height;
            var f = n.pc(),
              u = l.createImageData(g.width, g.height),
              t,
              z,
              C = g.width,
              N = g.height,
          ...
          zd: function (f) {
            !g &&
              ...
              ((g = document.createElement("canvas")),
              (l = g.getContext("2d")));
            var u = f ? g : document.createElement("canvas");
            u.width = e.width;
            u.height = e.height;
            (f ? l : u.getContext("2d")).drawImage(e, 0, 0);
            return u;
          },
          i: function (f) {
            f.gb && !f.fa
              ? (e = document.getElementById(f.gb))
              : f.fa && (e = f.fa);
            e || (e = document.createElement("canvas"));
            e.width = f && void 0 !== f.width ? f.width : 512;
            e.height = f && void 0 !== f.height ? f.height : 512;
            "undefined" === typeof f && (f = {});
            void 0 === f.premultipliedAlpha && (f.premultipliedAlpha = !1);
            void 0 === f.Ia && (f.Ia = !0);
            void 0 === f.antialias && (f.antialias = !1);
            var u = {
            ...
            d() || (p = e.getContext("webgl2", u));
            p
              ? (r = !0)
              : ((p = e.getContext("webgl", u)) ||
                  (p = e.getContext("experimental-webgl", u)),
                (r = !1));
            if (!p) return b("WebGL is not enabled");
            (k = p.getExtension("WEBGL_lose_context")) &&
              e.addEventListener("webglcontextlost", f.Pc, !1);
            if (!Ka.i()) return b("Not enough capabilities");
            if (!Ka.Zb() && r)
              return b("Your configuration cannot process color buffer float");
            p.clearColor(0, 0, 0, 0);
            p.disable(p.DEPTH_TEST);
            p.disable(p.BLEND);
            p.disable(p.DITHER);
            p.disable(p.STENCIL_TEST);
            p.GENERATE_MIPMAP_HINT && p.hint(p.GENERATE_MIPMAP_HINT, p.FASTEST);
            p.disable(p.SAMPLE_ALPHA_TO_COVERAGE);
            p.disable(p.SAMPLE_COVERAGE);
            return !0;
          },
          Ld: function () {
            if (!v.i()) return !1;
      ...
      var b,
        ...
        r = {
          ...
          a: function (m) {
            var n = e++,
              f = m.J ? m.J.length : 0,
              u = "undefined" === typeof m.mode ? p.STATIC_DRAW : m.mode,
              t = p.createBuffer();
            p.bindBuffer(p.ARRAY_BUFFER, t);
            p.bufferData(
              p.ARRAY_BUFFER,
              m.Nb instanceof Float32Array ? m.Nb : new Float32Array(m.Nb),
              u
            );
            g = n;
            if (m.J) {
              var z = p.createBuffer();
              p.bindBuffer(p.ELEMENT_ARRAY_BUFFER, z);
              if (65536 > m.J.length) {
                var C = Uint16Array;
                var N = p.UNSIGNED_SHORT;
                var J = 2;
              } else (C = Uint32Array), (N = p.UNSIGNED_INT), (J = 4);
              p.bufferData(
                p.ELEMENT_ARRAY_BUFFER,
                m.J instanceof C ? m.J : new C(m.J),
                u
              );
              l = n;
            }
            var O = {
              Yb: function (F) {
                g !== n && (p.bindBuffer(p.ARRAY_BUFFER, t), (g = n));
                F && Ia.Pa();
              },
              Wb: function () {
                l !== n && (p.bindBuffer(p.ELEMENT_ARRAY_BUFFER, z), (l = n));
              },
              bind: function (F) {
                O.Yb(F);
                O.Wb();
              ...
              sd: function () {
                p.drawElements(p.TRIANGLES, f, N, 0);
              },
              td: function (F, h) {
                p.drawElements(p.TRIANGLES, F, N, h * J);
              },
              remove: function () {
                p.deleteBuffer(t);
                m.J && p.deleteBuffer(z);
                O = null;
              },
            };
            return O;
          ...
          ya: function () {
            -1 !== g && (p.bindBuffer(p.ARRAY_BUFFER, b), (g = -1));
            -1 !== l && (p.bindBuffer(p.ELEMENT_ARRAY_BUFFER, d), (l = -1));
          },
          g: function (m, n) {
            m && G.ya();
            n && Ia.Qa();
            p.drawElements(p.TRIANGLES, 3, p.UNSIGNED_SHORT, 0);
          },
          oc: function () {
            p.deleteBuffer(b);
            p.deleteBuffer(d);
    ...
    E = (function () {
      ...
      return {
        i: function () {
          if (!g) {
            b = p.createFramebuffer();
            var k = Ka.m();
            d = k && p.DRAW_FRAMEBUFFER ? p.DRAW_FRAMEBUFFER : p.FRAMEBUFFER;
            e = k && p.READ_FRAMEBUFFER ? p.READ_FRAMEBUFFER : p.FRAMEBUFFER;
            g = !0;
          }
        },
        Dd: function () {
        ...
        a: function (k) {
          ...
          var r = k.fd ? k.fd : !1,
            ...
            t = !1,
            z = 0;
          r && ((m = m ? m : r.s()), (n = n ? n : r.F()));
          var C = {
            Gb: function () {
              t || ((f = p.createFramebuffer()), (t = !0), (z = l.mc++));
            },
            Qb: function () {
              C.Gb();
              C.j();
              u = p.createRenderbuffer();
              p.bindRenderbuffer(p.RENDERBUFFER, u);
              p.renderbufferStorage(p.RENDERBUFFER, p.DEPTH_COMPONENT16, m, n);
            ...
            bind: function (N, J) {
              z !== l.o && (p.bindFramebuffer(d, f), (l.o = z));
              r && r.j();
              J && p.viewport(0, 0, m, n);
              N && p.clear(p.COLOR_BUFFER_BIT | p.DEPTH_BUFFER_BIT);
            },
            md: function () {
              z !== l.o && (p.bindFramebuffer(d, f), (l.o = z));
            },
            ...
            rtt: function (N) {
              r = N;
              l.o !== z && (p.bindFramebuffer(p.FRAMEBUFFER, f), (l.o = z));
              N.j();
            },
            D: function () {
            ...
            remove: function () {
              ...
              p.bindFramebuffer(d, null);
              p.deleteFramebuffer(f);
              u && p.deleteRenderbuffer(u);
              C = null;
            },
          };
          k.ob && C.Qb();
        ...
        H: function () {
          0 !== l.o && (p.bindFramebuffer(d, b), (l.o = 0));
        },
        clear: function () {
          p.viewport(0, 0, Ka.s(), Ka.F());
          p.clear(p.COLOR_BUFFER_BIT);
    ...
    I = (function () {
      ...
      function d(c) {
        ...
        return 103 > Q
          ? B
          : 142 < Q
          ? B | 31744 | ((255 == Q ? 0 : 1) && c & 8388607)
          : 113 > Q
          ? ((D |= 2048), B | ((D >> (114 - Q)) + ((D >> (113 - Q)) & 1)))
          : (B = (B | ((Q - 112) << 10) | (D >> 1)) + (D & 1));
      }
      function e(c) {
        var B = new Uint16Array(c.length);
        c.forEach(function (D, Q) {
          B[Q] = d(D);
        });
        return B;
      }
      function g() {
        if (null !== na.Ea) return na.Ea;
        var c = k(e([1, 1, 1, 1]));
        return null === c ? !0 : (na.Ea = c);
      }
      function l() {
        if (null !== na.Fa) return na.Fa;
        var c = k(new Uint8Array([255, 255, 255, 255]));
        return null === c ? !0 : (na.Fa = c);
      }
      function k(c) {
        if (!Ia.Ja() || !N) return null;
        try {
          var B = p.getError(),
            D = W.a({ isFloat: !1, B: !0, array: c, width: 1 });
          B = p.getError();
          if (B !== p.NO_ERROR) return !1;
        } catch (Q) {
          return !1;
        }
        E.D();
      ...
      var r = 0,
        ...
        y = !1,
        aa = !1,
        oa = new Float32Array(1),
        ta = new Int32Array(oa.buffer),
        na = { Ea: null, Fa: null },
        W = {
          i: function () {
            if (!N) {
              z = [p.RGB, !1, p.RGB, p.RGBA];
              C = [p.RGB, !1, p.RGB, p.RGBA];
              m = [
                p.TEXTURE0,
                p.TEXTURE1,
                p.TEXTURE2,
              ...
              aa = "undefined" !== typeof Ka;
              y && JEContext.Sd() && m.push(p.TEXTURE8, p.TEXTURE9);
              f = [-1, -1, -1, -1, -1, -1, -1, -1];
              t = [p.UNSIGNED_BYTE, p.FLOAT, p.FLOAT];
              if (!u) {
                for (var c = new Float32Array(16384), B = 0; 16384 > B; ++B)
                  c[B] = 2 * Math.random() - 1;
                u = {
                  random: W.a({ isFloat: !0, isPot: !0, array: c, width: 64 }),
                  Mb: W.a({
                    isFloat: !1,
                    isPot: !0,
                    width: 1,
          ...
          Xc: function () {
            C = z = [p.RGBA, p.RGBA, p.RGBA, p.RGBA];
          },
          Sc: function (c, B) {
            v.set("s1");
            E.D();
            ...
            c.b(0);
            G.g(!1, !1);
            p.readPixels(0, 0, D, Q, p.RGBA, p.UNSIGNED_BYTE, B);
          },
          nc: function (c, B, D) {
            p.activeTexture(p.TEXTURE0);
            r = 0;
            var Q = p.createTexture();
            b(Q);
            var X = Ka.m() && p.RGBA32F ? p.RGBA32F : p.FLOAT;
            B = B instanceof Float32Array ? B : new Float32Array(B);
            var Y = Math.log2(B.length);
            Y !== Math.floor(Y) &&
            ...
            p.pixelStorei(p.UNPACK_FLIP_Y_WEBGL, D);
            p.texImage2D(
              p.TEXTURE_2D,
              0,
              p.RGBA,
          ...
          a: function (c) {
            function B() {
              b(ea);
              qa && p.pixelStorei(p.UNPACK_FLIP_Y_WEBGL, qa);
              c.isPot
                ? (p.texParameteri(
                    p.TEXTURE_2D,
                    p.TEXTURE_WRAP_S,
                    c.qb ? p.MIRRORED_REPEAT : p.REPEAT
                  ),
                  p.texParameteri(
                    p.TEXTURE_2D,
                    p.TEXTURE_WRAP_T,
                    c.K ? p.MIRRORED_REPEAT : p.REPEAT
                  ))
                : (p.texParameteri(
                    p.TEXTURE_2D,
                    p.TEXTURE_WRAP_S,
              ...
              c.la &&
                ...
                p.texParameterf(
                  p.TEXTURE_2D,
                  JEContext.Cd().TEXTURE_MAX_ANISOTROPY_EXT,
                  JESETTINGS.ld
                );
              p.texParameteri(
                p.TEXTURE_2D,
                p.TEXTURE_MAG_FILTER,
                c.isLinear ? p.LINEAR : p.NEAREST
              );
              c.isLinear
                ? p.texParameteri(
                    p.TEXTURE_2D,
                    p.TEXTURE_MIN_FILTER,
                    c.isMipmap && !wa ? p.NEAREST_MIPMAP_LINEAR : p.LINEAR
                  )
                : p.texParameteri(
                    p.TEXTURE_2D,
                    p.TEXTURE_MIN_FILTER,
                    c.isMipmap && !wa ? p.NEAREST_MIPMAP_NEAREST : p.NEAREST
                  );
              ja = z[c.Z - 1];
              fa = C[c.Z - 1];
              ma = t[D];
              if (Ka.m()) {
                var q = p.RGBA32F;
                ja === p.RGBA && ma === p.FLOAT && q && (fa = q);
                ja === p.RGB &&
                  ma === p.FLOAT &&
                  q &&
                  ((fa = q), (ja = p.RGBA));
              }
              if ((c.B && !c.isFloat) || (c.isFloat && c.isMipmap && Ja.Bc()))
                (q = p.RGBA16F) && (fa = q), (ma = Ka.ia());
              c.tb && "undefined" !== typeof p.texStorage2D && (L = c.tb);
              c.rb && 4 === c.Z && (ja = JEContext.Hd());
              if (c.v) p.texImage2D(p.TEXTURE_2D, 0, fa, ja, ma, c.v);
              else if (c.url) p.texImage2D(p.TEXTURE_2D, 0, fa, ja, ma, pa);
              else if (Z) {
                try {
                  p.getError(),
                    p.texImage2D(p.TEXTURE_2D, 0, fa, K, x, 0, ja, ma, Z),
                    p.getError() !== p.NO_ERROR &&
                      (p.texImage2D(p.TEXTURE_2D, 0, fa, K, x, 0, ja, ma, null),
                      p.getError() !== p.NO_ERROR &&
                        p.texImage2D(
                          p.TEXTURE_2D,
                          0,
                ...
                c.isKeepArray || (Z = null);
              } else p.texImage2D(p.TEXTURE_2D, 0, fa, K, x, 0, ja, ma, null);
              if (c.isMipmap)
                if (!wa && A) A.Ca(), (ka = !0);
                else if (wa) {
                  q = Math.log(Math.min(K, x)) / Math.log(2);
                  var R;
                  xa = Array(1 + q);
                  xa[0] = ea;
                  for (R = 1; R <= q; ++R) {
                    ...
                    p.texImage2D(p.TEXTURE_2D, 0, fa, H, P, 0, ja, ma, null);
                    b(null);
                    xa[R] = M;
                  }
                  ka = !0;
              ...
              b(null);
              f[r] = -1;
              qa && p.pixelStorei(p.UNPACK_FLIP_Y_WEBGL, !1);
              T = !0;
              ca && A && (ca(A), (ca = !1));
            }
            ...
            void 0 === c.Z && (c.Z = 4);
            void 0 === c.pb && (c.pb = !1);
            "undefined" === typeof c.isFlipY &&
              (c.isFlipY = c.url || c.array ? !0 : !1);
            ...
            c.isFloat && (c.B = !0);
            c.B && (D = 1);
            c.pb || Ka.m() || !c.isFloat || !aa || Ka.eb() || (c.isFloat = !1);
            c.isFloat && (D = 2);
            c.la && y && !JEContext.Nd() && (c.la = !1);
            var ea = p.createTexture(),
              ca = c.za,
              pa = null,
              Z = !1,
              K = 0,
              ...
              qa = c.isFlipY,
              wa =
                c.B && c.isMipmap && "undefined" !== typeof Ja && !Ja.ac()
                  ? !0
                  : !1,
              xa,
              L = -1,
              ka = !1;
            "undefined" !== typeof c.width &&
              c.width &&
              ((K = c.width),
              (x = "undefined" !== typeof c.height && c.height ? c.height : K));
            var A = {
              get: function () {
                return ea;
              },
              ...
              cb: function (q, R) {
                wa
                  ? (q || (q = A.jb()), A.xa(R), b(xa[q]), (f[R] = -1))
                  : A.b(R);
              },
              jb: function () {
                -1 === L && (L = Math.log(K) / Math.log(2));
                return L;
              },
              ib: function (q) {
                if (wa) {
              ...
              refresh: function () {
                A.bb(0);
                qa && p.pixelStorei(p.UNPACK_FLIP_Y_WEBGL, !0);
                Q
                  ? p.texImage2D(p.TEXTURE_2D, 0, fa, ja, p.UNSIGNED_BYTE, c.v)
                  : p.texImage2D(p.TEXTURE_2D, 0, fa, K, x, 0, ja, ma, Z);
                qa && p.pixelStorei(p.UNPACK_FLIP_Y_WEBGL, !1);
              },
              fb: function () {
                ...
                ha = [
                  new Float32Array(ua[0].buffer),
                  new Float32Array(ua[1].buffer),
                  new Float32Array(ua[2].buffer),
                  new Float32Array(ua[3].buffer),
                ];
                Ca = new Uint8Array(4 * q);
                Aa = new Float32Array(Ca.buffer);
                S = !0;
              },
              Oa: function () {
                S || A.fb();
                p.readPixels(0, 0, K, 4 * x, p.RGBA, p.UNSIGNED_BYTE, Ca);
                var q,
                  R = K * x,
                  P = 2 * R,
                  H = 3 * R;
              ...
              ge: function (q) {
                ...
                R
                  ? (da ||
                      ...
                      (X.height = x),
                      (Y = X.getContext("2d")),
                      (ra = Y.createImageData(K, x)),
                      (da = !0)),
                    ra.data.set(q),
                    Y.putImageData(ra, 0, 0),
                    p.texImage2D(p.TEXTURE_2D, 0, fa, ja, ma, X))
                  : p.texImage2D(p.TEXTURE_2D, 0, fa, K, x, 0, ja, ma, q);
                f[r] = U;
                qa && p.pixelStorei(p.UNPACK_FLIP_Y_WEBGL, !1);
              },
              he: function (q, R) {
                b(ea);
                p.pixelStorei(p.UNPACK_FLIP_Y_WEBGL, R);
                p.texImage2D(p.TEXTURE_2D, 0, fa, ja, ma, q);
                f[r] = U;
                R && p.pixelStorei(p.UNPACK_FLIP_Y_WEBGL, !1);
              },
              Wd: function (q, R) {
                var P = K * x,
                  H = 4 * P;
                q = c.B ? (q ? "RGBE" : "JSON") : "RGBA";
                R && (q = R);
                R = Ka.m() && !1;
                switch (q) {
                  case "RGBE":
                ...
                S ||
                  ("RGBA" === q || "RGBE" === q || "RGBAARRAY" === q
                    ? ((ua = new Uint8Array(H)), (S = !0))
                    : "JSON" !== q || R || A.fb());
                E.D();
                v.set(M);
                A.b(0);
                if ("RGBA" === q || "RGBE" === q || "RGBAARRAY" === q) {
                  p.viewport(0, 0, K, x);
                  G.g(!0, !0);
                  p.readPixels(0, 0, K, x, p.RGBA, p.UNSIGNED_BYTE, ua);
                  if ("RGBAARRAY" === q) return { data: ua };
                  J ||
                  ...
                  O.width = K;
                  O.height = x;
                  h = F.createImageData(K, x);
                  h.data.set(ua);
                  F.putImageData(h, 0, 0);
                  var ba = O.toDataURL("image/png");
                } else if ("JSON" === q)
                  if (R)
                    (ba = new Float32Array(P)),
                      p.viewport(0, 0, K, x),
                      G.g(!0, !0),
                      p.readPixels(0, 0, K, x, p.RGBA, p.FLOAT, ba);
                  else {
                    for (ba = 0; 4 > ba; ++ba)
                      p.viewport(0, x * ba, K, x),
                        v.Jb("u8", w[ba]),
                        G.g(!ba, !ba);
                    A.Oa();
                    ba = Array(P);
            ...
            if (c.url)
              ...
              var la = function () {
                K = void 0 !== c.v.videoWidth ? c.v.videoWidth : c.v.width;
                x = void 0 !== c.v.videoHeight ? c.v.videoHeight : c.v.height;
                K ? B() : setTimeout(la, 1);
              };
              la();
            } else
              c.array
                ? (c.B && !c.isFloat
                    ? c.array instanceof Uint16Array
                      ...
                      : (B(), W.nc(A, c.array, qa))
                    : ((Z = c.isFloat
                        ? c.array instanceof Float32Array
                          ? c.array
                          : new Float32Array(c.array)
                        : c.array instanceof Uint8Array
                        ? c.array
                        : new Uint8Array(c.array)),
                      B()),
                  c.isKeepArray ||
                    (Z && Z !== c.array && (Z = null), delete c.array))
                : B();
            A.vc = A.s;
            ca && T && (ca(A), (ca = !1));
            return A;
          ...
          reset: function () {
            for (var c = 0; c < m.length; ++c) f[c] = -1;
            r = -1;
          },
          Vd: function () {
            r = -1;
    ...
    Ka = (function () {
      function b() {
        d = "undefined" === typeof La ? JEContext : La;
        e = !0;
      }
      var d,
        e = !1,
        ...
        h = {
          ...
          jc: function () {
            z = (t =
              ...
              p.getExtension("WEBGL_color_buffer_float") ||
              p.getExtension("OES_color_buffer_float"))
              ? !0
              : !1;
            F.GL_EXT_COLORBUFFERFLOAT = t;
          },
          kc: function () {
            p.getExtension("EXT_color_buffer_half_float") ||
              p.getExtension("WEBGL_color_buffer_half_float") ||
              p.getExtension("OES_color_buffer_half_float");
          },
          hb: function () {
            if (!g) {
              this.m() ||
                ((l =
                  p.getExtension("OES_texture_float") ||
                  p.getExtension("MOZ_OES_texture_float") ||
                  p.getExtension("WEBKIT_OES_texture_float")),
                (r = (F.GL_EXT_FLOAT = l) ? !0 : !1));
              if (r || this.m())
                (k =
                  p.getExtension("OES_texture_float_linear") ||
                  p.getExtension("MOZ_OES_texture_float_linear") ||
                  p.getExtension("WEBKIT_OES_texture_float_linear")),
                  (F.GL_EXT_FLOATLINEAR = k);
              g = !0;
            }
          },
          Ba: function () {
            if (!u) {
              if (!this.m()) {
                if (
                  (m =
                    p.getExtension("OES_texture_half_float") ||
                    p.getExtension("MOZ_OES_texture_half_float") ||
                    p.getExtension("WEBKIT_OES_texture_half_float"))
                )
                  (O = m.HALF_FLOAT_OES), (n = !0);
                !O && p.HALF_FLOAT && (O = p.HALF_FLOAT);
                !O && p.FLOAT && (O = p.FLOAT);
                F.GL_EXT_HALFFLOAT = m;
              }
              if (n || this.m())
                (f =
                  p.getExtension("OES_texture_half_float_linear") ||
                  p.getExtension("MOZ_OES_texture_half_float_linear") ||
                  p.getExtension("WEBKIT_OES_texture_half_float_linear")),
                  (F.GL_EXT_HALFFLOATLINEAR = f);
              u = !0;
            }
          },
          ia: function () {
            if (h.m()) return p.HALF_FLOAT;
            h.Ba();
            return n ? O : p.FLOAT;
          },
          eb: function () {
          ...
          gc: function () {
            N = C = !0;
            var w = p.createFramebuffer();
            p.bindFramebuffer(p.FRAMEBUFFER, w);
            var y = p.createTexture();
            ...
            p.texImage2D(
              p.TEXTURE_2D,
              0,
              h.m() && p.RGBA32F ? p.RGBA32F : p.RGBA,
              1,
              1,
              0,
              p.RGBA,
            ...
            var aa = p.checkFramebufferStatus(E.Da());
            aa !== p.FRAMEBUFFER_COMPLETE && (C = !1);
            p.texImage2D(
              p.TEXTURE_2D,
              0,
              h.m() && p.RGBA16F ? p.RGBA16F : p.RGBA,
              1,
              1,
              0,
              p.RGBA,
            ...
            aa = p.checkFramebufferStatus(E.Da());
            aa !== p.FRAMEBUFFER_COMPLETE && (N = !1);
            p.bindTexture(p.TEXTURE_2D, null);
            p.bindFramebuffer(p.FRAMEBUFFER, null);
            p.deleteTexture(y);
            p.deleteFramebuffer(w);
          },
          fc: function () {
            var w = E.a({ width: 1 });
            w.Gb();
            var y = I.a({ width: 1, isFloat: !0, Z: 3 });
            w.j();
            y.j();
            p.flush();
            p.checkFramebufferStatus(E.Da()) !== p.FRAMEBUFFER_COMPLETE
              ? (I.Xc(), (J = !1))
              : (J = !0);
            w.remove();
            y.remove();
    ...
    Ja = (function () {
      function b(C, N, J, O) {
        p.texParameteri(
          p.TEXTURE_2D,
          p.TEXTURE_MIN_FILTER,
          O ? p.NEAREST_MIPMAP_NEAREST : p.LINEAR
        );
        try {
          var F = p.getError();
          F !== p.NO_ERROR && console.log("GLERR in test_mipmapping() :", F);
          p.texImage2D(p.TEXTURE_2D, 0, C, 2, 2, 0, p.RGBA, N, J);
          F = p.getError();
          if (F !== p.NO_ERROR) return !1;
        } catch (h) {
          return !1;
        }
        O && p.generateMipmap(p.TEXTURE_2D);
        G.ya();
        G.g(!1, !0);
        p.readPixels(0, 0, 1, 1, p.RGBA, p.UNSIGNED_BYTE, m);
        F = p.getError();
        F === p.INVALID_OPERATION &&
          "undefined" !== typeof p.PIXEL_PACK_BUFFER &&
          (p.bindBuffer(p.PIXEL_PACK_BUFFER, null),
          p.readPixels(0, 0, 1, 1, p.RGBA, p.UNSIGNED_BYTE, m),
          (F = p.getError()));
        return F !== p.NO_ERROR ? !1 : 0 !== m[0];
      }
      function d(C) {
        return Ka.eb() &&
          b(internalPixelFormat32f, p.FLOAT, new Float32Array(f), C)
          ? ((k = l.Va), !0)
          : !1;
      }
      function e(C) {
        return Ka.$b()
          ? b(t, Ka.ia(), new Uint16Array(f), C) ||
            b(t, p.FLOAT, new Float32Array(f), C)
            ? ((k = l.ta), !0)
            : !1
          : !1;
      }
    ...
    Oa = {
      a: function (b) {
        ...
        if (b.mask) {
          d = !0;
          a && void 0 !== a.Ub && (b.mask = a.Ub + b.mask);
          var e = I.a({ isFloat: !1, url: b.mask });
        }
        var g = !1,
          ...
          r = !1;
        b.sift
          ? Sift.i({ xc: p, fa: !1, width: b.size, Ud: b.siftOutWidth })
          : b.DWT && DWT.i({ xc: p, fa: !1, width: b.size });
        var m = !1;
        b.customInputShader &&
          ((m = "s43"),
          v.Xa({
        ...
        switch (l) {
          ...
          case "inputLightRegulation":
            n = m ? m : "s29";
            Ra.i({ width: b.size, vb: b.nBlurPass, Ac: !1 });
            g = !0;
            break;
          case "direct":
          case "none":
        ...
        r && v.C(n, [{ name: "u28", type: "1f", value: b.tilt }]);
        d && (n += "Mask");
        if (b.blur) var f = I.a({ isFloat: !1, isPot: !1, width: b.size });
        var u = I.a({ isFloat: !1, isPot: !1, width: b.size }),
          t = {
            s: function () {
            ...
            tc: function () {
              return b.sift ? Sift.ja() : b.DWT ? DWT.ja() : g ? Ra.ja() : u;
            },
            w: function () {
              E.H();
              b.blur &&
    ...
    Pa = {
      a: function (b) {
        ...
        var d = [],
          ...
          t = b.kernelsNumber ? !0 : !1,
          z = b.dynPelu ? Na.a(b.dynPelu) : !1,
          C = z ? !0 : !1,
          N = { isEnabled: !1 },
          J;
        if ("softmax" === b.type) {
          ...
          v.C("s20", [{ type: "1f", name: "u10", value: b.gain }]);
          var O = I.a({ isFloat: !0, isPot: !1, width: b.size }),
            F = I.a({ isFloat: !0, isPot: !1, width: b.size, isMipmap: !0 });
          m = !1;
          var h = new Uint8Array(Math.pow(4 * b.size, 2)),
            w;
          for (w = 0; w < b.size * b.size; ++w) {
            var y = w < b.num_classes ? 255 : 0;
            h[4 * w] = y;
            h[4 * w + 1] = y;
            h[4 * w + 2] = y;
            h[4 * w + 3] = y;
          ...
          b.cost
            ? ((b.sparsity =
                "undefined" !== typeof b.sparsity ? b.sparsity : b.L.Y()),
              (m = !1))
            : "full" === b.connectivityUp && (b.sparsity = b.L.Y());
        var oa = {
            elu: "s15",
            elu01: "s16",
            relu: "s14",
        ...
        if (b.maxPooling) {
          ...
          na = !0;
          W /= b.maxPooling.size;
          var B = I.a({ isFloat: !0, isPot: !1, width: W });
        }
        var D = void 0 !== b.Oc && b.Oc ? !0 : !1,
          Q = null,
          X = null,
          Y = null;
        D &&
          ((Q = "s45" + b.index.toString()),
          v.nb("s45", Q, [((b.normalization.n - 1) / 2).toFixed(1)]),
          v.C(Q, [
          ...
          (X = I.a({ isFloat: !0, isPot: !0, width: b.size })),
          (Y = I.a({ isFloat: !0, isPot: !0, width: b.size })));
        var da, ra, ea, ca;
        m && (ca = I.a({ isFloat: !0, isPot: !1, width: b.size }));
        var pa = I.a(b.bias),
          Z,
          K = {
            s: function () {
            ...
            Rc: function () {
              b.remap &&
                ...
                (N = {
                  ...
                  layers: b.remap.layers.map(function (x) {
                    return b.parent.rc(x);
                  }),
                  depth: b.remap.depth,
                });
            },
            Zc: function () {
              switch (b.connectivityUp) {
                case "gaussian":
                  Z = Sa.a(b.connectivity);
                  break;
                case "direct":
                  Z = Ta.a(b.connectivity);
                  break;
                case "square":
                  Z = Ua.a(b.connectivity);
                  break;
                case "squareFast":
                  Z = Va.a(b.connectivity, b.activation);
                  break;
                case "full":
                  Z = Wa.a(b.connectivity);
                  break;
                case "conv":
                  (f = b.kernelsNumber),
                    (Z = Xa.a(b.connectivity)),
                    u &&
                      (n = I.a({
                        width: W,
                        isFloat: !0,
              ...
              if (Z.M) {
                var x = b.size * b.sparsity;
                ra = Math.log(x / b.size) / Math.log(2);
                da = I.a({
                  isMipmap: !0,
                  isFloat: !0,
                  isPot: !0,
                ...
                ea = I.a({ isFloat: !0, isPot: !0, width: b.size });
              }
            },
            w: function (x, T) {
              J = x;
              Z.M
                ? (da.u(),
                  ...
                  da.ib(ra),
                  ea.u(),
                  t ? v.set("s0") : (v.set("s28"), v.A("u27", ta), pa.b(1)),
                  da.cb(ra, 0),
                  G.g(!1, !1),
                  v.set(oa),
                  D ? X.j() : ca.j(),
              ...
              if (b.cost) {
                v.set("gpuRawAvg" === k ? "s8" : "s7");
                T = ca;
                b.disableNormalize ||
                  (v.A("u4", 1 / b.size), g.u(), ca.b(0), G.g(!1, !1), (T = g));
                switch (k) {
                  case "cpuRGBA2Float":
                    T.Aa();
                    U = K.Ab(T);
            ...
            dc: function (x) {
              x && "undefined" !== typeof x.zb && ((k = x.zb), (r = x.Qc));
              ca = I.a({
                isFloat: !0,
                isPot: !0,
              ...
              "softmax" === b.type &&
                (l = I.a({ isFloat: !0, isPot: !0, width: 1 }));
              var T = 0,
                U = 0,
                S =
                  "undefined" !== typeof b.num_classes && b.num_classes
                    ? b.num_classes
                    : b.size * b.size;
              for (x = 0; x < S; ++x)
                d.push(T + (b.size - 1 - U) * b.size),
                  e.push([-1, -1, -1, -1]),
                  ++T,
                  T === b.size && ((T = 0), ++U);
              b.disableNormalize ||
                (g = I.a({ isFloat: !0, isPot: !0, width: b.size }));
            },
            Ab: function (x) {
              x.Aa();
              var T = x.Oa();
              d.forEach(function (U, S) {
                e[S][0] = T[0][U];
                e[S][1] = T[1][U];
                e[S][2] = T[2][U];
                e[S][3] = T[3][U];
  ...
  function Ya() {
    ...
    this.Wc = function (g) {
      var l = !1;
      d = g.map(function (k, r) {
        return (l = k = Qa.a({ index: r, parent: this, dd: k, L: l }));
      });
      e = d[d.length - 1];
  ...
  var Ta = {
        ...
        return {
          ...
          w: function (g) {
            if (g.isEnabled) {
              ...
              g.Dc.b(3);
              var l,
                k = Math.min(g.layers.length, g.depth);
              for (l = 0; l < k; ++l) g.layers[l].Xb(4 + l);
            } else v.set("s24");
    ...
    Ua = {
      a: function (b) {
        ...
        for (m = 0; m < e; ++m)
          for (n = 0; n < e; ++n) {
            var aa = Math.round(m * r);
            var oa = Math.round(n * r);
            var ta = m / e;
            var na = n / e;
            ta += h;
            na += h;
        ...
        var ra = I.a(b.weights);
        I.a({ width: l, isFloat: !0, array: new Float32Array(J), isPot: !0 });
        J = null;
        var ea = I.a({
          width: l,
          isFloat: !0,
    ...
    Va = {
      a: function (b, d) {
        var e = b.fromLayerSize,
          ...
          u =
            "s47" +
            [e.toString(), g.toString(), l.toString(), k.toString(), d].join(
              "_"
            );
        v.lc(u) ||
          ((b = Da(d)),
          (g = [
            { type: "1f", name: "u18", value: g },
            { type: "1f", name: "u32", value: k },
          ]),
          m && g.push({ type: "1f", name: "u26", value: e }),
          (e = [(m ? r : l).toFixed(1), b]),
    ...
    Ra = (function () {
      var b, d, e, g, l, k, r, m, n;
      return {
        i: function (f) {
          b = f.vb ? f.vb : 3;
          d = f.width ? f.width : 64;
          g = f.Ac ? !0 : !1;
          f = { isFloat: !1, width: d, isPot: !1, isFlipY: !1 };
          l = I.a(f);
          k = I.a(f);
          r = I.a(f);
          m = I.a(f);
          n = I.a({ isFloat: !0, width: d, isPot: !1, isFlipY: !1 });
          e = 1 / d;
        },
        Na: function (f) {
          v.set("s37");
  ...
  function db(b) {
    ...
    if (b.video) {
      ...
      "undefined" !== typeof b.video.facingMode &&
        (d.facingMode = b.video.facingMode);
    }
  ...
  function fb(b) {
    function d(t) {
      return [
        ...
        return Math.abs(z - t) - Math.abs(C - t);
      });
    }
    function e(t) {
      var z = db(b);
    ...
    if (b.video.width && b.video.height) {
      if (b.video.width.ideal && b.video.height.ideal)
        for (
          ...
          m = l[r];
          for (var n = 0, f; n < k.length; ++n)
            if (
              ((f = k[n]),
              m !== b.video.width.ideal || f !== b.video.height.ideal)
            ) {
              var u = Math.max(m, f) / Math.min(m, f);
              u < 4 / 3 - 0.1 ||
                u > 16 / 9 + 0.1 ||
                e(function (t) {
                  t.video.width.ideal = m;
                  t.video.height.ideal = f;
                  return t;
                });
            }
        }
  ...
  function gb(b) {
    ...
    if (d && b && b.video) {
      ...
      d &&
        ...
        e.ideal &&
        d.ideal > e.ideal &&
        ((b.video.height = d), (b.video.width = e));
    }
  }
  function hb(b) {
    b.volume = 0;
    ...
    navigator.mediaDevices
      ...
      .then(function (r) {
        function m() {
          setTimeout(function () {
            if (b.currentTime) {
              var n = b.videoWidth,
                f = b.videoHeight;
              if (0 === n || 0 === f) l("VIDEO_NULLSIZE");
              else {
                n && (b.style.width = n.toString() + "px");
                f && (b.style.height = f.toString() + "px");
                n = { bc: null, cd: null, Gc: null };
                try {
                  var u = r.getVideoTracks()[0];
                  u &&
                    ((n.Gc = u),
                    (n.bc = u.getCapabilities()),
                    (n.cd = u.getSettings()));
                } catch (t) {}
                bb() || $a()
        ...
        "undefined" !== typeof b.srcObject
          ? (b.srcObject = r)
          : ((b.src = window.URL.createObjectURL(r)), (b.videoStream = r));
        hb(b);
        b.addEventListener(
          "loadeddata",
          function () {
  ...
  function jb(b, d, e) {
    var g = cb() ? document.createElement("video") : !1;
    if (g)
      if (cb()) {
        if (e && e.video) {
          if ($a()) {
            var l = ab();
            (12 > l[0] || (12 === l[0] && 2 > l[1])) && gb(e);
          }
          e.video.width &&
            e.video.width.ideal &&
            (g.style.width = e.video.width.ideal + "px");
          e.video.height &&
            e.video.height.ideal &&
            (g.style.height = e.video.height.ideal + "px");
        }
        Za(g, "autoplay");
        Za(g, "playsinline");
        e && e.audio ? (g.volume = 0) : Za(g, "muted");
        ib(
          g,
          b,
          function () {
            function k(m) {
              if (0 === m.length) d("INVALID_FALLBACKCONSTRAINS");
              else {
                var n = m.shift();
                ib(
                  g,
  ...
  var kb = (function () {
      ...
      return {
        ...
        ed: function (k, r, m) {
          k.forEach(function (n, f) {
            var u = Math.min(1, e[f] * m * (r + 0.33 * (1 - r)));
            n = u * n + (1 - u) * g[f];
            g[f] = n;
            l[f] = d[f](n);
          });
    ...
    lb = {
      facingMode: "user",
      // idealWidth: 320,
      idealWidth: window.innerWidth * 0.6,
      // idealHeight: 240,
      idealHeight: window.innerHeight * 0.7,
      minWidth: 240,
      maxWidth: 1280,
      minHeight: 240,
      maxHeight: 1280,
    ...
    a = {
      ...
      mb: [3, 7],
      lb: 0.05,
      Sb: [0.2, 0.2, 0.15, 0.15, 0.15, 0.15, 0.2, 0.2, 0.15, 0.15, 0.2],
      Kc: [
        ya.bind(null, 0.05, 0.7),
        ya.bind(null, 0.05, 0.7),
        ya.bind(null, 0, 0.4),
        ya.bind(null, 0, 0.4),
        ya.bind(null, 0, 0.6),
        ya.bind(null, 0, 0.6),
        za.bind(null, 0.1, 0.6),
        ya.bind(null, 0.1, 0.4),
        Ba.bind(null, 0.68, 0.77, 2),
        Ba.bind(null, 0.68, 0.77, 2),
        ya.bind(null, 0.15, 0.5),
      ],
    };
  ...
  var mb = !1,
    nb = !1;
  function ob() {
    var b, d, e, g, l, k, r, m, n, f, u;
    function t() {
      1 === ++K &&
        (kb.i(a.Sb, a.Kc),
        z(),
        (V.ready = !0),
        V.T.forEach(function (L) {
          L();
        }),
        V.T.splice(0, V.T.length),
        C(),
        (K = 0));
    }
    function z() {
      X = va();
      Y = new Uint8Array(oa * oa * 4);
      ...
      V.set_morphUpdateCallback = function (L) {
        pa = L;
      };
      ...
      V.switch_sleep = function (L) {
        T !== x.qa || L ? (T = L ? x.qa : x.ga_) : C();
      };
      V.on_detect = function (L) {
        L(U.G);
        U.Ma.push(L);
      };
    ...
    function N() {
      T !== x.qa && (w = setTimeout(J, h));
    }
    function J() {
      var L = c.currentTime - wa;
      0 > L && (wa = c.currentTime);
      1e3 * L < a.kd ||
        (B.refresh(),
        (wa += L),
        v.set("s49"),
      ...
      S.timestamp = ka;
      S.wb = L / A;
      S.Ka = S.wb * a.da + S.Ka * (1 - a.da);
      S.xb = 1e3 / A;
      S.P = S.xb * a.da + S.P * (1 - a.da);
      S.P > a.N[1]
        ? (++S.na, (S.P = (a.N[0] + a.N[1]) / 2))
        : S.P < a.N[0] &&
          ((S.na = Math.max(S.na - 1, a.Ua)), (S.P = (a.N[0] + a.N[1]) / 2));
      S.ea = a.Vb / Math.max(S.Ka, 0.001);
      T !== x.qa && (y = window.requestAnimationFrame(N));
    }
    var O,
      F,
      h = a.Tb,
      ...
      T = x.Cc,
      U = { ma: 0, G: !1, Ma: [] },
      S = { timestamp: 0, wb: 0, Ka: 0, na: a.Ua, xb: 0, P: 0, ea: 1 },
      ha = 1,
      ua = 1,
      Ca = 1,
      Aa = 1,
      ...
      xa = {
        ...
        i: function (L) {
          function ka() {
            var P = A(a.mb[0], a.mb[1]);
            U.ma = a.lb * P + (1 - a.lb) * U.ma;
            0.6 < U.ma && !U.G
              ? (U.Ma.forEach(function (H) {
                  H(!0);
                }),
                (U.G = !0))
              : 0.4 > U.ma &&
          ...
          function A(P, H) {
            P += oa * H;
            return (
              (Y[4 * P] + Y[4 * P + 1] + Y[4 * P + 2] + Y[4 * P + 3]) / 1020
            );
          }
          function la() {
            X.forEach(function (P, H) {
              if (U.G) {
                P = (a.ub + H) % oa;
                var M = a.Jc + Math.floor((a.ub + H) / oa);
                M = oa - 1 - M;
                P = A(P, M);
                X[H] = P;
              } else X[H] = 0;
          ...
          function q(P) {
            ...
            aa.Yc({
              ...
              Qc: function (H) {
                ...
                v.A("u47", ha);
                v.Ib("u39", d, e, g);
                v.Ib("u40", 1 * a.Ra[0], 1 * a.Ra[1], 1 * a.Ra[2]);
                G.g(!1, !1);
                1 !== ++b % 2 &&
                  ((g += r),
                  g > W &&
                ...
                H = Date.now();
                M = H - ja;
                var ba = A(a.Bb[0], a.Bb[1]);
                Ca = za(a.Cb[0], a.Cb[1], ba);
                ba = A(a.R[0], a.R[1]);
                var Ea = A(a.R[0] + 1, a.R[1]),
                  Fa = A(a.R[0] + 2, a.R[1]);
                ua =
                  1 -
                  za(
                    a.Eb[0],
                    a.Eb[1],
                    Math.sqrt(ba * ba + Ea * Ea + Fa * Fa) / M
                  );
                ba = fa[0] - da[0];
                Ea = fa[1] - da[1];
                Fa = fa[2] - da[2];
                M = Math.sqrt(ba * ba + Ea * Ea + Fa * Fa) / M;
                fa[0] = da[0];
                fa[1] = da[1];
                fa[2] = da[2];
                Aa = 1 - za(a.Db[0], a.Db[1], M);
                ha = Ca * ua * Aa;
                ja = H;
                ma[qa] = ha;
                qa = (qa + 1) % a.La;
                for (H = 0; H < a.La; ++H) ha = Math.min(ma[H], ha);
                kb.ed(X, ha, S.ea);
                pa && pa(ha, S.ea);
                if (U.G)
                  for (
                    H = a.Za[1] * ha + a.Za[0] * (1 - ha), H *= S.ea, M = 0;
                    3 > M;
                    ++M
                  )
                    (ra[M] = H * da[M] + (1 - H) * ra[M]), (ca[M] = ra[M]);
                else
                  (H = Date.now()),
                    (ea[0] = a.$a[0] * Math.sin(H * a.ab)),
                    (ea[1] = a.$a[1] * Math.cos(H * a.ab)),
                    (ca[0] = ea[0]),
                    (ca[1] = ea[1]),
                    (ca[2] = ea[2]);
                H = D;
          ...
          c = L;
          B = I.a({ v: c, isPot: !1, isFloat: !1, isFlipY: !0 });
          v.Rb([
            {
              id: "s49",
              name: "_",
              $: "attribute vec2 a0;uniform vec2 u34,u35;varying vec2 vv0;void main(){gl_Position=vec4(a0,0.,1.),vv0=u35+u34*a0;}",
              ca: ["a0"],
              U: [2],
              c: "uniform sampler2D u1;varying vec2 vv0;void main(){gl_FragColor=texture2D(u1,vv0);}",
              f: ["u1", "u34", "u35"],
            ...
            },
            {
              ...
              name: "_",
              c: "uniform sampler2D u1;varying vec2 vv0;void main(){gl_FragColor=texture2D(u1,vv0);}",
              $: "attribute vec2 a0;uniform sampler2D u36;uniform vec2 u37;const vec2 f=vec2(.25,.5),h=vec2(.75,.5),e=vec2(.5,.5);varying vec2 vv0;void main(){vec4 a=texture2D(u36,f);vec2 b=a.gb,c=a.a*u37,d=a0*.5+e;vv0=b+(d-e)*c,gl_Position=vec4(a0,0.,1.);}",
              ca: ["a0"],
              U: [2],
              f: ["u1", "u36", "u37"],
              precision: "lowp",
            ...
            },
            {
              id: "s53",
              name: "_",
              c: "uniform sampler2D u1,u5;uniform float u52,u53,u47;const vec4 f=vec4(1.,1.,1.,1.);varying vec2 vv0;void main(){vec4 a=texture2D(u1,vv0),b=texture2D(u5,vv0);float c=(1.-u47)*(u53-u52)+u52;gl_FragColor=mix(b,a,c*f);}",
              f: ["u1", "u5", "u52", "u53", "u47"],
            },
          ]);
          v.C("s50", [
            ...
            { type: "2f", name: "u37", value: ta },
          ]);
          v.C("s52", [
            { type: "1i", name: "u36", value: 0 },
            { type: "2f", name: "u37", value: ta },
            { type: "3f", name: "u51", value: [0, 0.5, 1] },
          ]);
          v.C("s51", [
            { type: "1i", name: "u38", value: 0 },
            { type: "1i", name: "u36", value: 1 },
            { type: "1f", name: "u41", value: a.Ic },
            { type: "1f", name: "u42", value: a.Fc },
            { type: "1f", name: "u43", value: a.gd },
            { type: "1f", name: "u44", value: a.Pb },
            { type: "1f", name: "u45", value: a.Ob },
            { type: "1f", name: "u46", value: ta[0] },
          ]);
          v.C("s53", [
            { type: "1i", name: "u1", value: 0 },
            { type: "1i", name: "u5", value: 1 },
            { type: "1f", name: "u52", value: a.Ya[0] },
            { type: "1f", name: "u53", value: a.Ya[1] },
          ]);
          Q = I.a({ isPot: !1, isFloat: !1, width: O, height: F });
          var R = new Float32Array([0, a.borderWidth, a.W, 0]);
          (function (P) {
            P.Ga = I.a({ isPot: !1, Td: !0, isFloat: !1, width: O, height: F });
            P.Ha = I.a({ isPot: !0, isFloat: !1, width: a.ka });
            var H = { width: 1, height: 1, isFloat: !0, isPot: !1, array: R };
            P.ra = Ma.a(H);
            P.Kb = Ma.a(H);
          })(D);
          nb
        ...
        $c: function (L, ka) {
          for (var A in L) "undefined" !== typeof ka[A] && (L[A] = ka[A]);
        },
        cc: function (L) {
          V.va && V.va();
          var ka = {
            video: {
              facingMode: { ideal: lb.facingMode },
              width: {
                min: lb.minWidth,
                max: lb.maxWidth,
                ideal: lb.idealWidth,
              ...
              height: {
                min: lb.minHeight,
                max: lb.maxHeight,
                ideal: lb.idealHeight,
              },
            },
            audio: V.Wa,
          };
          lb.deviceId && (constraints.deviceId = lb.deviceId);
          jb(
            function (A, la) {
              mb = la;
              V.wa && V.wa();
        ...
        sb: function (L, ka) {
          ...
          la > A
            ? 1 >= la
              ? (q[0] *= la)
              : (q[1] /= la)
            : ((q[0] *= la), (la = 1 / A), (q[0] *= la), (q[1] *= la));
          q[1] *= A;
          xa.i(L);
          v.C("s49", [
            { type: "1i", name: "u1", value: 0 },
            { type: "2f", name: "u34", value: q },
  ...
  V.switch_displayVideo = function (b) {
    V.ba = b;
    V.aa && (V.aa.style.display = V.ba ? "block" : "none");
  };
  ...
  V.set_color = function (b) {
    v.C("s52", [{ type: "3f", name: "u51", value: b }]);
  };
  V.init = function (b) {
    var d = ob(),
      e = b.callbackReady
    ...
    if ("undefined" === typeof b.canvasId) e("NO_CANVASID");
    else if (document.getElementById(b.canvasId))
      if (V.initialized) e("ALREADY_INITIALIZED");
      else {
        V.initialized = !0;
        window.sa = e
          ? function (l) {
          ...
          : !1;
        b.NNCpath && (a.Ta = b.NNCpath);
        "undefined" !== typeof b.NNC &&
          (nb = "string" === typeof b.NNC ? JSON.parse(b.NNC) : b.NNC);
        g && V.T.push(g);
        if (
          !La.i({
            gb: b.canvasId,
        ...
        b.videoSettings && b.videoSettings.videoElement
          ? d.sb(b.videoSettings.videoElement, !1)
          : (b.videoSettings && d.$c(lb, b.videoSettings),
            d.cc(function (l) {
              d.sb(l, !1);
            }));
        return !0;
